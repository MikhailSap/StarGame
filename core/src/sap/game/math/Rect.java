...
public class Rect {
    ...
    public Rect(Rect from) {
        this(from.pos.x, from.pos.y, from.halfWidth, from.halfHeight);
    ...
    public void setHalfWidth(float width) {
        halfWidth = width/2f;
    }

    public void setHalfHeight(float height) { halfHeight = height/2f; }
